...
namespace Chess.Pieces
{
    ...
    public class King : Piece
    {
        ...
        public King(System.Windows.Point point, bool v)
        {
            Point = point;
            V = v;
        }
    ...
    public class Queen : Piece
    {
        ...
        public Queen(System.Windows.Point point, bool v)
        {
            Point = point;
            V = v;
        }
    ...
    public class Rook : Piece
    {
        ...
        public Rook(System.Windows.Point point, bool v)
        {
            Point = point;
            V = v;
        }
    ...
    public class Bishop : Piece
    {
        ...
        public Bishop(System.Windows.Point point, bool v)
        {
            Point = point;
            V = v;
        }
    ...
    public class Knight : Piece
    {
        ...
        public Knight(System.Windows.Point point, bool v)
        {
            Point = point;
            V = v;
        }
